...
public final class PageRankWiki {
  ...
  public static void PrintTop100Pages(List<Tuple2<Integer, Double>> output)
  {
	  ...
	  System.out.println("*************Output Top 100 Pages Start***********************");
	    int outputLimit = 100;
	    int counter = 0;
	    Collections.sort(sortedByRank, new SortByRankInt());
	    
	    for (Tuple2<?,?> tuple : sortedByRank) {
	      if(counter >= outputLimit)
	    	  break;
	      counter++;
	      System.out.println(tuple._1() + " has rank: " + tuple._2() + ".");
	    }
	    System.out.println("*************Output Top 100 Pages End***********************");
